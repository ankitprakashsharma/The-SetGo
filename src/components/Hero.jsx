  ...
  return (
    <>
      ...
      <ol className="benefits-list">
        ...
        <li>Get healthy, strong and shredded</li>
      ...
      <small>* The first and second set should be at 75% and 85% of your working weight used for the last two set.</small>
      <h3>The Training Plan</h3>
      <p>
        The training plan uses a structure know as the <b>Bro Split</b>, and follows this rotation ⬇️
      </p>
